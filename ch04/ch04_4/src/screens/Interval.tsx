...
export default function Intarval(){
    ...
    return(
        <View style={styles.view}>
            ...
            <Text style={styles.title}>Intarval</Text>
...
const styles = StyleSheet.create({
    ...
    topBar:{width:'100%',flexDirection:'row',padding:5,justifyContent:'space-between',backgroundColor:Colors.blue500},
